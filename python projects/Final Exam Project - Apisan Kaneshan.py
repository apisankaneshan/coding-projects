...
#ICS2O, Mr. Kordbacheh
#11/06/2019
#Self Directed App - Culminating


#import random to use in the game to generate cards
import random
#import a module from python to organize the cards and use pictures
import sys

#make constants:
HEARTS = chr(10084) #The card 'hearts' is imported from the sys module using the ASCII
DIAMONDS = chr(9830) #The card 'diamonds' is imported from the sys module using the ASCII
SPADES = chr(9824) #The card 'spades' is imported from the sys module using the ASCII
CLUBS = chr(9827) #The card 'clubs' is imported from the sys module using the ASCII
BACKSIDE = ('backside') #This is the backside of each card
...
#give the user 100 units to start with
money = 100
#identify the pot value
pot = 0
